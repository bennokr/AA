 ...
 */
public class ParallelQLearningEGreedyPredatorAgent extends ParallelQLearningPredatorAgent {
     ...
     */
    public ParallelQLearningEGreedyPredatorAgent(final Location location) {
        super(location);
    }
